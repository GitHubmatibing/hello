...
/* Home Page Panel */
	...
	$wp_customize->add_section( 'logo_section' , array(
		...
		// width
		$wp_customize->add_setting( 'busiprof_pro_theme_options[width]', array( 'default' => 138 , 'type' => 'option'	) );
		...
		// height
		$wp_customize->add_setting( 'busiprof_pro_theme_options[height]', array( 'default' => 49 , 'type' => 'option' ) );
	...
	$wp_customize->add_section( 'footer_copy_section' , array(
		...
		// copyright text
		$wp_customize->add_setting( 'busiprof_pro_theme_options[footer_copyright_text]', array( 'default' => '<p>'.__( '©2017 All Rights Reserved - Webriti. - Designed and Developed by', 'busiprof' ).' <a href="http://www.webriti.com/" target="_blank">'.__('Webriti', 'busiprof').'</a>.</p> ' , 'type' => 'option' ) );
