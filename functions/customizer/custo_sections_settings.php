...
/* Sections Settings */
	...
	$wp_customize->add_section( 'bannerstrip_section' , array(
		...
		// Banner strip text
		$wp_customize->add_setting( 'busiprof_pro_theme_options[intro_tag_line]', array( 'default' =>__('Busiprof: the perfect WordPress theme for an app and web developer', 'busiprof' ) , 'type' => 'option' ) );
	...
	$wp_customize->add_section( 'services_section' , array(
		...
		array( 'default' => __('Awesome Services', 'busiprof' ) , 'type'=>'option' ) );
		...
		$wp_customize->add_setting( 'busiprof_pro_theme_options[service_tag_desciption]', array( 'default' => __('We are a group of passionate designers and developers who really love creating awesome WordPress themes and giving support.', 'busiprof' ) , 'type'=>'option' ) );
	...
	$wp_customize->add_section( 'project_section' , array(
		...
		array( 'default' => __('We are a group of passionate designers and developers who really love creating awesome WordPress themes and giving support.','busiprof'), 'type'=>'option' ) );
	...
	$wp_customize->add_section( 'blog_section' , array(
		...
		// blog section title
		$wp_customize->add_setting( 'busiprof_pro_theme_options[blog_head]', array( 'default' => __('Recent Blog', 'busiprof' ) , 'type'=>'option' ) );
		...
		// blog section desc
		$wp_customize->add_setting( 'busiprof_pro_theme_options[blog_tagline]', array( 'default' => __('We are a group of passionate designers and developers who love to create awesome WordPress themes with an amazing support and the coolest video documentation.', 'busiprof' ) , 'type'=>'option' ) );
	...
	$wp_customize->add_section( 'testimonial_section' , array(
		...
		array( 'default' => __('Our Testimonials', 'busiprof' ) , 'type'=>'option' ) );
		...
		// testmonial section desc
		$wp_customize->add_setting( 'busiprof_pro_theme_options[testimonial_tagline]', array( 'default' => __('We are a group of passionate designers and developers who really love creating awesome WordPress themes and giving support.', 'busiprof' ) , 'type'=>'option' ) );
